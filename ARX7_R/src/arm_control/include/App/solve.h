...
public:
    ...
    KDL::JntArray joint_positions = KDL::JntArray(7);
    KDL::JntArrayVel jointCurrentVel = KDL::JntArrayVel(7);
    KDL::Twist targetCartAcc, tempTwist;

    KDL::JntArray jointPrevPositions = KDL::JntArray(7);
    KDL::JntArray jointPrevVelocities = KDL::JntArray(7);
    KDL::JntArray jointVelocities = KDL::JntArray(7);
    KDL::JntArray jointAcclerations = KDL::JntArray(7);
    KDL::JntArray jointTorques = KDL::JntArray(7);
    KDL::JntArray jointPrevTorques = KDL::JntArray(7);
    ...
    arx5_state arm_calc2(command arx_cmd_t,float *back_pos,float *send_pos,bool control_mode_t,float gripper,int arx7_r);
    ...
    float Joint_Control(float*target_pos,float*current_pos ,bool& is_teach_mode,bool& current_normal);
    float control(float*target_pos,bool& is_teach_mode,bool& current_normal,float gripper_t,float* current_pos,float* current_vel);
    float arx_tor[4]={};
    ...
    float lower_bound_sim[7] = { -2.09439  , -1.5, -1.5 ,-1.5 , -1.2  , -0.3   ,-0.7854};
    float upper_bound_sim[7] = { 2.09439   ,  0.3,  1.5 , 0.3 ,  1.2  , 0.7854 , 0.7854};
    float r_lower_bound_sim[7] ={ -2.09439 , -0.3, -1.5 , -0.3 , -1.2  , -0.7854,-0.7854};
    float r_upper_bound_sim[7] = { 2.09439 , 1.5,  1.5 , 1.5,   1.2  , 0.3    , 0.7854};

    int control_mode_s =3;
